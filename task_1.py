    ...
    def rate_lec(self, lector, course, grade):
        if isinstance(lector, Lecturer) and course in self.finished_courses and course in lector.courses_attached:
            ...
            if course in lector.grades and grade in rating_scale:
                course.grades[course].append(grade)
            else:
...
# проверка методов
student_1.rate_lec(lecturer_1, 'Java', 10)  # несотв. лектора и курса
student_1.rate_lec(lecturer_1, 'SQL', 8)
student_2.rate_lec(lecturer_1, 'SQL', 10)
student_2.rate_lec(lecturer_2, 'SQL', 5)
print('Оценки 1-го преподавателя', lecturer_1.grades)

reviewer_1.rate_hw(student_1, 'CSS', 7)
